...
- When a phrase says 'before the year XXXX', 'from before the year XXXX', or 'before XXXX', ALWAYS set yearmax to XXXX - 1 and explicitly keep yearmin as null (never set yearmin to XXXX in these cases)
...
- Common year expressions to recognize:
  ...
  * 'before 2015' -> yearmin: null, yearmax: 2014
  * 'before the year 2017' -> yearmin: null, yearmax: 2016
  * 'from before the year 2017' -> yearmin: null, yearmax: 2016
  ...
  * 'cars from before the year 2017' -> yearmax: 2016
