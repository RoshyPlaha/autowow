...
const hobby = () => {
  return (
    <div className="relative min-h-screen w-full bg-white overflow-hidden bg-[#e9e1e5]">
      ...
      <LandingPage
        heroTextProps={{
          normalText: "Record your Hobby",
          standoutText: "Progress.",
          tagline:
            "Those scuffs, scratches, wont hurt for long. But remind youself of that first heel slide",
        }}
        displayImageProps={{
        ...
        secondaryHeroTextProps={{
          ...
          standoutText: "capture your skills",
        }}
        descriptionPropOne={{
